...
public class Member {
    ...
    @NotEmpty(message = "펫 유무를는 필수값입니다." , groups = ValidationGroups.NotEmptyGroup.class)
    ...
    @NotEmpty(message = "원하는 펫 종류를 골라주세요. 필수값입니다.", groups = ValidationGroups.NotEmptyGroup.class)
