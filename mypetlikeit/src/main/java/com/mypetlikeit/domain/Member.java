...
public class Member {
    ...
    public Member(long id,
            ...
            @NotBlank(message = "펫 유무를는 필수값입니다.", groups = NotBlankGroup.class) String petYN,
            @NotBlank(message = "원하는 펫 종류를 골라주세요. 필수값입니다.", groups = NotBlankGroup.class) String wantPet) {
        this.id = id;
